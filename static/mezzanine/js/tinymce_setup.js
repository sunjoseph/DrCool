...
if (typeof tinyMCE != 'undefined') {
    ...
    tinyMCE.init({
        ...
        theme_advanced_buttons1: "bold,italic,underline,|,link,unlink,|,image,|,media,charmap,|,code,|,table,|,bullist,numlist,|,justifyleft,justifycenter,justifyright,|,formatselect,fontselect,fontsizeselect,|,blockquote,|,undo,redo,|,formatselect,|,search,replace,|,fullscreen,",
